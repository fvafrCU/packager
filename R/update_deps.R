...
#' this, and \code{\link[remotes:update_packages]{remotes:update_packages}} does
#' so only for CRAN packages, and \code{remotes:::update.package_deps} is
#' internal to \pkg{remotes} only. So need copies of internal functions from
#' \pkg{remotes}.
#'
